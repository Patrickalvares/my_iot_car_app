...
import 'package:my_iot_car_app/calibration_alerts/step_five.dart';
...
class FourthStep extends StatefulWidget {
  ...
  @override
  State<FourthStep> createState() => _FirsStepState();
}

class _FirsStepState extends State<FourthStep> {
  @override
  void initState() {
    SetCalibrationStep.setCalibrationStep(4);
    super.initState();
  }
          ...
          TextButton(
            onPressed: () {
              ...
              Future.delayed(const Duration(milliseconds: 100), () {
                showDialog(
                  context: context,
                  builder: (context) => const FifthStep(),
                );
              });
            },
            child: const Text(
